...
it('should provide Style Class list to callback function', async () => {
  const input = '[psc=Folder1/class1][psc=Folder2/class2].otherClass { color: black; }'
...
it('should only provide unique Style Classes to callback function', async () => {
  const input = '[psc=Folder1/class1][psc=Folder2/class2].otherClass [psc=Folder2/class2] { color: black; }'
